...
1. Make sure to save your bot identity token generated for you at step 3.  NOTE: You must complete the submit step of the bot wizard before you can start using your bot identity token to connect to ROAR.
